      ...
      <Row>
        ...
        <div className='d-flex' data-aos="fade-right" data-aos-easing="linear" data-aos-duration="2000">
            <div className='d-flex flex-column mx-5'>
                    <a href='https://github.com/JustinW7' className='text-dark my-3' target='_blank'><i class="uil uil-github-alt fa-2x"></i></a>
                    <a href='https://www.linkedin.com/in/7justinvarghese/' className='text-dark my-3' target='_blank'><i class="uil uil-linkedin-alt fa-2x"></i></a>
                    <a href='https://www.instagram.com/michealangelo_7/' target='_blank' className='text-dark my-3'><i class="uil uil-instagram fa-2x"></i></a>
                    <a href='https://twitter.com/7justinV' target='_blank' className='text-dark my-3'><i class="uil uil-twitter-alt fa-2x"></i></a>
                </div>
                <div className='d-flex flex-column my-4'>
                  
                    <h3 className='text-dark fw-bold'>Justin Varghese </h3>
...
<a href="mailto:ashishsamuelthomson@gmail.com?subject = Hello Message&body = Message to say hello" className='text-dark' style={{textDecoration:'none'}}><button className='btn btn-dark hello-btn'>Say Hello</button></a>
        ...
        <Col lg={5} md={5} sm={12} className='text-center' data-aos="zoom-in" data-aos-easing="linear" data-aos-duration="2000">
            <img className='profileImage' src="/images/profileneck.png" alt="profile image" />
        </Col>
      </Row>
