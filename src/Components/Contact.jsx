  ...
  return (
    <section className='contact-section' id='contact'>
      ...
      <h3 className='text-dark fs-4'>Talk to me</h3>
                ...
                <p>Email</p>
                <p>justinvarghsew7@gmail.com</p>
                <a href="mailto:justinvarghesew7@gmail.com?subject = Connection Message&body = Message to connect" className='text-dark' style={{textDecoration:'none'}}><button className='btn btn-dark'>Write Me<i class="uil uil-arrow-right"></i></button></a>
                </div>
